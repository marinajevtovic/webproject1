...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/firenca.css" media="screen and (min-width: 800px)">
    <link rel="stylesheet" type="text/css" href="css/firencamob.css" media="screen and (max-width: 799px)">
<style>
    #omotac{
        margin: 0 auto;
