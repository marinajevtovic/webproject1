...
<head>
    <meta charset="utf-8" />
    <title>Valensija</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="main.css" />
    <link rel="stylesheet" type="text/css" href="css/valensija.css" media="screen and (min-width: 800px)">
    <link rel="stylesheet" type="text/css" href="css/valensijamob.css" media="screen and (max-width: 799px)">
<style>
    #omotac{
        margin: 0 auto;
